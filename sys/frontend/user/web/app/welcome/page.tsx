    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
            <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
                ...
                <div className="mt-4 flex flex-row min-w-full items-center justify-center">
                    <section
                        id="download"
                        className="rounded-md py-4 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-300 to-blue-300"
                    >
                        <div className="max-w-2xl mx-auto text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                                <a
                                    href="#"
                                    className="bg-white text-gray-800 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition flex items-center space-x-3 shadow-xl"
                                >
                                    <svg
                                        className="w-8 h-8"
                                        viewBox="0 0 24 24"
