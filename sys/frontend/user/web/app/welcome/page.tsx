        ...
        <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
            <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-4 sm:px-8 lg:px-16 bg-white dark:bg-black sm:items-start">
                ...
                <div className="mt-4 flex flex-row w-full items-center justify-center">
                    <section
                        id="download"
                        className="rounded-md py-4 px-2 sm:px-4 lg:px-8 bg-gradient-to-r from-purple-300 to-blue-300"
                    >
                        <div className="max-w-2xl mx-auto text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                                <a
                                    href="#"
                                    className="bg-white text-gray-800 px-4 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-gray-100 transition flex items-center space-x-2 sm:space-x-3 shadow-xl w-full sm:w-auto"
                                >
                                    <svg
                                        className="w-8 h-8"
                                        viewBox="0 0 24 24"
