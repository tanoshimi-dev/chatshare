I want create mobile app using React Native.

App Title: AI Chat share

App Description: AI Chat share is a mobile application that allows users to share their Chat public link like Claude Code , Chat GPT, etc.
App users read someone's chats and improve self understanding , or simply enjoy it.
